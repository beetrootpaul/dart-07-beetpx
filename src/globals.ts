...
export const g = {
  ...
  assets: {
    ...
    sfxOptionsChange: "0",
    sfxOptionsConfirm: "2",
    sfxPowerupNoEffect: "5",
    sfxPowerupPicked: "6",
    sfxPlayerShoot: "10",
    sfxPlayerTripleShoot: "11",
    sfxPlayerShockwave: "12",
    sfxEnemyShoot: "13",
    sfxEnemyMultiShoot: "14",
    sfxDamagePlayer: "16",
    sfxDamageEnemy: "17",
    sfxDestroyPlayer: "19",
    sfxDestroyEnemy: "20",
    sfxDestroyBossPhase: "21",
    sfxDestroyBossFinal1: "22",
    sfxDestroyBossFinal2: "23",
    sfxDestroyBossFinal3: "24",
    sfxGameWin: "25",
  },
